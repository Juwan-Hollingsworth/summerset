      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          <div className="space-y-8">
            <Link to="/" className="flex flex-col">
              <span className="text-3xl font-serif tracking-tighter text-white leading-none">SUMMERSET</span>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/blog" className="text-white/60 hover:text-white transition-colors text-sm">Summerset Journal</Link></li>
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">invest@summerset.com</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[10px] uppercase tracking-widest text-white/20">
            © 2026 Summerset at Greenpark. All Rights Reserved. | Powered by CyBrWerks.io
          </p>
          <p className="text-[10px] uppercase tracking-widest text-white/20">
